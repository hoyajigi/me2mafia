...
final class Me2AuthenticatedUser extends Me2Person {
    ...
    function post(
        $post, $tags = '', $callbackurl="http://me2toy.hoyajigi.com/me2mafia/vote.php" ,$iconurl = "http://me2toy.hoyajigi.com/me2mafia/icon.gif",
        $attachment = null, $comment = Me2Comment::Opened
    ) {
        return new Me2Post($this, $post, $tags, $callbackurl,$iconurl, $attachment, $comment);
    }
